...
-- 3. Insert categories of each product
...
/* 4. Lookup a product by its product_id */
SELECT * FROM product where pid = 1;

/* 5. Return all products that belong to a specific selected category/multiple selected categories */
SELECT * FROM Product
...
/* 6. Return all products that belong to a specific price range */
SELECT * FROM product where (price >= 15 and price <= 20);

/* 7. Return all products that belong to a specific rating range */
SELECT * FROM product where (rating >= 4 and rating <= 5);

/* 8. Sort products by price or ratings (both ascending and descending) */
SELECT * FROM product ORDER BY rating ASC;
SELECT * FROM product ORDER BY rating DESC;
SELECT * FROM product ORDER BY price ASC;
SELECT * FROM product ORDER BY price DESC;

/* 9. Sort all products in the selected category/categories by price */
...
/* 10. Sort all products in the selected category/categories by rating */
SELECT * FROM product WHERE
...
/* 11. Sort all products in the selected price range(s) by rating */
SELECT * FROM product WHERE
...
/* 12. Return all products in the selected category/categories in the selected price range(s), 
